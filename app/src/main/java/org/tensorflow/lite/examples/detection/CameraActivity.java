...
public abstract class CameraActivity extends AppCompatActivity
    ...
    protected TextView peopleDetectedTextView, resultTextView, timeTextView;    protected ImageView bottomSheetArrowImageView;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        peopleDetectedTextView = findViewById(R.id.people_info);
        resultTextView = findViewById(R.id.result_info);
        timeTextView = findViewById(R.id.time_info);

        threadsTextView.setText(TFLiteFaceMask.NUM_THREADS + "");
...
//        }
    ...
    protected void showPeopleDetected(String peopleInfo) {
        peopleDetectedTextView.setText(peopleInfo);
    }

    protected void showLabel(String labelInfo) {
        resultTextView.setText(labelInfo);
    }

    protected void showTime(String inferenceTime) {
        timeTextView.setText(inferenceTime);
    }
